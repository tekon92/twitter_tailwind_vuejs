<template>
  <div class="flex flex-col border p-4 hover:bg-gray-200" @click="move">
    ...
    >
      <div class="popper">
        <div class="flex flex-col bg-white w-64 border border-gray-300 p-2">
          <div class="flex justify-between w-full">
            ...
            />
            <button class="p-4 items-center flex items-center text-blue-500 bg-white border border-blue-400 rounded-full hover:bg-blue-500 hover:border-white hover:text-white">Follow</button>
          </div>
          <div class="flex flex-col p-2 text-left">
            ...
            <span class="text-sm text-gray-500">
              ...
              >tekon92.github.io/resume-rian/</a>
            </span>
        ...
        <div class="flex flex-col ml-2">
          <div class="flex justify-between items-center">
            <span class="flex">
              ...
              <h2 class="ml-1 font-xs text-gray-500">@fahrihamzah . 5s</h2>
            </span>
            <a href="#" class="p-2 rounded-full hover:bg-blue-100 hover:text-blue-300">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                stroke="currentColor"
    ...
    <div class="flex justify-around mt-4 text-gray-700">
      <div class="flex items-center hover:text-blue-500">
        <a href="#" class="flex items-center p-2 hover:bg-blue-100 rounded-full">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            stroke="currentColor"
      ...
      <div class="flex items-center hover:text-green-500">
        <a href="#" class="flex items-center p-2 hover:bg-green-100 rounded-full">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            stroke="currentColor"
      ...
      <div class="flex items-center hover:text-red-500">
        <a href="#" class="flex items-center p-2 hover:bg-red-100 rounded-full">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            stroke="currentColor"
